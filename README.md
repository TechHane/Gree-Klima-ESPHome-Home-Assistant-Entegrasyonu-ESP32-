...
Bulut bağımlılığı olmadan, ESP32 mikrodenetleyicisi ve ESPHome yazılımı kullanılarak klima doğrudan Home Assistant'a entegre edilebilir. Ayrıca koda eklenen Web Sunucusu (Web Server) özelliği sayesinde, Home Assistant kapalı olsa dahi cihazın IP adresi üzerinden tarayıcı ile klima kontrolü sağlanabilmektedir.
